...
TIER_PLANS: Dict[str, PlanTierConfig] = {
    "tier_free": PlanTierConfig(
        name="Free Clone Tier",
        daily_limit=500,  # Generous daily limit per bot
        max_concurrent_vcs=10,  # Up to 10 concurrent active VCs
    ...
    "tier_enterprise": PlanTierConfig(
        name="Enterprise",
        daily_limit=-1,
        max_concurrent_vcs=100,
        max_audio_duration_sec=86400, # 24 hours
        max_video_duration_sec=86400,
        audio_bitrate_kbps=320,
        allow_video=True,
        allow_custom_dsp=True,
        allow_live_stream=True,
